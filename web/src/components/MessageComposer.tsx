    ...
    <div className="px-5 pb-4 pt-2 relative">
      ...
      <div className="flex items-stretch border-3 border-nb-black dark:border-dark-border bg-nb-white dark:bg-dark-surface shadow-nb transition-shadow focus-within:shadow-nb-lg overflow-hidden">
        <textarea
          ...
          rows={1}
          className="flex-1 px-3 py-2.5 bg-transparent text-base lg:text-sm font-body text-nb-black dark:text-dark-text placeholder:text-nb-gray-400 dark:placeholder:text-dark-muted resize-none focus:outline-none min-h-[46px]"
        />
