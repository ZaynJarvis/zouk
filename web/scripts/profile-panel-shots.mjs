...
const AGENT_FULL = {
  ...
  name: 'alice',
  displayName: 'Alice',
  description: 'Operations agent — frontend screenshot QA + local ops on a local development machine. Pairs with Bob on UI polish and owns the screenshot-eval pattern.',
  runtime: 'claude',
  ...
  workDir: '/Users/shared/.zouk/agents/agent-c97d0a85',
